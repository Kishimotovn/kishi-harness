...
The named enterprise hosted pools belong to `deepseek-ai/deepseek-harness`. Forks use [standard hosted PR defaults](2026-09-13-fork-pull-request-ci.md) unless an operator explicitly selects failover; the switches and their runner prerequisites below remain applicable.
