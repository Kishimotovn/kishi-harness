...
The [Kishi fork platform policy](2026-09-16-fork-linux-macos-ci.md) defines the Linux/macOS-only exception; the scheduling and platform trade-offs below describe upstream.
