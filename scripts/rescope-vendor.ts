...
const GENERIC_SKIPS: readonly GenericSkip[] = [
  ...
  { file: 'apps/web/tests/creator-mcp.e2e.ts', upstream: ['cordis'] },
  { file: 'packages/experimental/mcp-creator/src/index.ts', upstream: ['cordis'] },
  { file: 'packages/experimental/mcp-creator/tests/index.spec.ts', upstream: ['cordis'] },
