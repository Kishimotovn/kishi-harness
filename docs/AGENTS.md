...
- **Language maintenance:** follow the [fork policy](agents/documentation-policy.md). English-only mode preserves Chinese files and pairing records; [bilingual requirements](i18n/README.md) apply otherwise.
